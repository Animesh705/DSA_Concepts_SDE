package stack_queue;
import java.util.*;
public class Implement_Stack_usingArray {
        ...
        // Constructor
        public Implement_Stack_usingArray(int size) {
            capacity = size;
        ...
        public Implement_Stack_usingArray() {
            this(1000);
        }
        ...
        public static void main(String[] args) {
            Implement_Stack_usingArray stack = new Implement_Stack_usingArray();
